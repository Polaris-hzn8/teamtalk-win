...
DoLoginServerHttpOperation::DoLoginServerHttpOperation(IN module::IOperationDelegate callback,
                                                       IN DoLoginServerParam& param)
  : IHttpOperation(callback), m_param(param) {}
