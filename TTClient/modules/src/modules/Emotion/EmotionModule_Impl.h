...
#include <modules/Emotion/EmoCfgParseTool.h>
...
private:
	EmotionDialog*				m_emotionWindow;//指向 EmotionDialog 窗口的指针，用于显示表情窗口
	std::string					m_sid;			//当前显示窗口的会话ID
	EmoCfgParseTool*			m_pEmotionKey;	//指向 EmoCfgParseTool 的指针，用于解析表情配置文件
};
