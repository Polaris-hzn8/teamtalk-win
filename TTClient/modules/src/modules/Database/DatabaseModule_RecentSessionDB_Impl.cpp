...
const std::string getAllRecentSessionSql = "select * from recentSessionInfo order by updatedTime desc limit 100";
const std::string getRecentSessionByIdSql = "select * from recentSessionInfo where sessionId=? limit 1";
const std::string insertRecentSessionSql =
  ...
  "VALUES(?,?,?,?,?,?);";
const std::string deleteRecentSessionSql = "delete from recentSessionInfo where sessionId=?";
const std::string updateRecentSessionByIdSql =
  "UPDATE recentSessionInfo SET sessionId = ?,sessionType = ?,updatedTime = ?,lastMsgId = ?,lastMsgData = "
  "?,latestMsgFromId=? where sessionId = ?";
