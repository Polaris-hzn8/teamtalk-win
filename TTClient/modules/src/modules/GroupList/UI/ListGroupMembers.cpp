...
ListGroupMembers::ListGroupMembers(CPaintManagerUI& paint_manager) : UIIMList(paint_manager) {}
...
Node* ListGroupMembers::AddNode(const IMListItemInfo& item, Node* parent /*= NULL*/, int index /*= 0*/) {
  ...
  CButtonUI* log_button =
    static_cast<CButtonUI*>(UIIMList::paint_manager_.FindSubControlByName(pListElement, kLogoButtonControlName));
  if (log_button != NULL) {
