...
public:
	...
	virtual void tcpGetGroupsInfo(IN const module::GroupVec& VecGroupId);//获取多个群信息
	virtual void tcpShieldGroup(IN const std::string& groupId, IN UInt32 shieldStatus);//设置群消息提醒状态
