...
#include <modules/ScreenCapture/UI/BkgroundUI.h>
...
void UIScreenCaptureMgr::forceForgroundWindow(__in HWND hWnd) {
  ...
  if (!AttachThreadInput(dwPid, GetCurrentThreadId(), TRUE) || !::SetForegroundWindow(hWnd) ||
...
BOOL UIScreenCaptureMgr::createWindows() {
  ...
  EditToolbarInfo toolBarInfo = {0,
                                 ...
                                 strHoverPic,
                                 strSelPic,
                                 {{9, 5, 35, 31}, {43, 5, 69, 31}, {85, 5, 112, 31}, {119, 5, 185, 31}}};
