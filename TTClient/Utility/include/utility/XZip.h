...
//
extern UTILITY_API ZRESULT ZipAdd(HZIP hz, const TCHAR* dstzn, void* src, unsigned int len, DWORD flags);
...
extern UTILITY_API HZIP CreateZipZ(void* z, unsigned int len, DWORD flags);
extern UTILITY_API ZRESULT CloseZipZ(HZIP hz);
