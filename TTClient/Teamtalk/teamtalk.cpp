...
#include <imcore/operation/OperationManager.h>
...
BOOL CteamtalkApp::_CreateMainDialog() {
  ...
  if (!m_pMainDialog->Create(
        NULL, csTitle, UI_CLASSSTYLE_DIALOG, WS_EX_STATICEDGE /*| WS_EX_APPWINDOW*/ | WS_EX_TOOLWINDOW, 0, 0, 600, 800))
    return FALSE;
