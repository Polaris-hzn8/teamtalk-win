...
const std::string KEY_FILESEVER_UPLOAD_OFFLINE_FINISH =
  MODULE_FILETRAS_PREFIX + "UploadOfflineFinish";  // 离线文件上传到文件服务器完成
const std::string KEY_FILESEVER_UPDATA_PROGRESSBAR =
  MODULE_FILETRAS_PREFIX + "UploadProgressBar";  // 离线文件上传进度条
...
class IFileTransferModule : public module::ModuleBase, public module::IPduPacketParse {
 public:
