...
class ScreenCapture {
 ...
 public:
  ...
  BOOL startCapture(__in std::wstring strSavePath,
 ...
 private:
  ...
  static LRESULT CALLBACK MsgWindowProc(_In_ HWND hwnd, _In_ UINT uMsg, _In_ WPARAM wParam, _In_ LPARAM lParam);
