...
// HttpPoolModule_Impl
///////////////////////////////////////////////////////////////////////////////
HttpPoolModule_Impl::HttpPoolModule_Impl() : m_hSemaphore(NULL), m_bShutdown(FALSE), m_maxThreadCount(1) {
  ...
  for (TTHttpThread* pThread : m_vecHttpThread) {
    if (pThread) {
      if (!pThread->waitForExit(2000)) {
        LOG__(
          ERR, _T("HttpPoolModule_Impl::shutdown: thread did not exit in 2000ms (id: %lu)"), pThread->getThreadId());
      }
      delete pThread;
      pThread = NULL;
    }
...
// TTHttpThread
///////////////////////////////////////////////////////////////////////////////
TTHttpThread::TTHttpThread(HttpPoolModule_Impl* owner) : m_Owner(owner), m_bContinue(TRUE) {}
